...
public class PruebaBaseNetflix {
    ...
    private static final String URL_NETFLIX="https://www.netflix.com/uy/";
    ...
    public void setup(){
        ...
        driverChrome.get(URL_NETFLIX);
        driverChrome.manage().window().maximize();
        driverChrome.navigate().refresh();
        driverChrome.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

        netflixLandingPage= new NetflixLandingPage(driverChrome);
    }
